...
CURSOR_FILE = DATA / "history_cursor_2025.json"
...
START_OFFSET = "2025-01-01T00:00:00Z"
END_OFFSET = "2026-01-01T00:00:00Z"
...
for page_number in range(1, PAGES_PER_RUN + 1):
    if cursor >= END_OFFSET:
        print("STOP 2025: s-a ajuns la 01.01.2026", flush=True)
        break
